---
title: "Interactive Client in Python"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Interactive Client in Python}
...
This vignette shows how to use the PeerChat Python bindings — a CPython C
extension that wraps the same networking core used by the R package.
...
This compiles the C extension (`py_peer_chat.c`, `client_lib.c`, `c_common.c`)
and installs the `PeerChat` package.
