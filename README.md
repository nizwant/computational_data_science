...
[![Python-tests](https://github.com/nizwant/computational_data_science/actions/workflows/python-tests.yaml/badge.svg)](https://github.com/nizwant/computational_data_science/actions/workflows/python-tests.yaml)
<!-- badges: end -->
...
3. To message someone, request their address from the server via `peer_get_user()`
...
# Connect to the server
PeerChat.connect("my_username", "my_password")

# Discover a peer
PeerChat.get_user("friend", "friends_password")
PeerChat.receive(1000)  # wait for server response

# Send a message
PeerChat.send_message("friend", "Hello my friend!")

# Receive incoming packets
PeerChat.receive(1000)
...
This repo is for WUT course aimed at learning C with Data Science algorithms in mind. It features a peer-to-peer messaging built on UDP with a central synchronization server for peer discovery.
